            ...
            <table class="table table-striped table-hover text-center">
                ...
                <?php $count=1; while($rows = $data->fetch()){ ?>
                    <tr>
                            ...
                            <td>
                                <?=$rows['permission']==2?'-':'<a href="users.php?delete='.$rows['ID'].'"
                                   class="btn btn-xs btn-danger" onclick="return confirm(\'آیا از حذف اطمیان دارید؟ این عمل غیر قابل بازگشت می باشد.\')">حذف</a>'?>
                            </td>
                    </tr>
                <?php } ?>
                </tbody>
