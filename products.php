...
$sort = " ORDER BY `created_at` DESC"; // پیش‌فرض
...
//prodocts list
$products = $conn->query("SELECT * FROM `products` WHERE TRUE $where AND `status`=1 $sort");
        ...
        <div class="row mt-5 pb-5">
            <div class="col-md-3">
                <form action="" method="get">
                    ...
                    <div class="form-group p-2">
                        <div class="px-3 pt-2 bg ">
                            <label for="priceRange" class="form-label">حداکثر قیمت: <span id="priceValue">50000</span> تومان</label>
