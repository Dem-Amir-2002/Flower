...
// $faq = [
//     "سلام" => "سلام! خوش آمدید به فروشگاه گل و گیاه.",
//     "چطور از گیاهان آپارتمانی نگهداری کنم؟" => "گیاهان آپارتمانی را در نور کافی و با آب مناسب نگهداری کنید.",
//     "ساعات کاری فروشگاه چیه؟" => "ساعات کاری ما همه روزه از 9 صبح تا 8 شب است.",
//     "ارسال سفارش چقدر طول میکشه؟" => "ارسال سفارشات بین 1 تا 3 روز کاری انجام می‌شود.",
//     "چه گیاهانی موجود دارین؟" => "ما انواع گل‌های آپارتمانی، گلدان‌های تزئینی و دانه و بذر گیاهان را داریم.",
//     "چطور خرید کنم؟" => "می‌توانید با کلیک روی دکمه خرید در صفحه محصول، خرید خود را تکمیل کنید."
// ];
?>
