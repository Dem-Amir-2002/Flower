                        ...
                        <form class="form-group px-3" action="" method="post">
                            <div class="form-group row">
                                <div class="form-group col-md-6">
                                    <label class="mb-2"><i class="fas fa-heading ml-2 text-muted"></i> نام</label>
                                    <input type="text" name="name" value="" class="form-control mb-2" placeholder="نام خود را وارد کنید" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="mb-2"><i class="fas fa-at ml-2 text-muted"></i> پست الکترونیک</label>
                                    <input type="email" name="email" class="form-control mb-2" placeholder="ایمیل خود را وارد کنید" required>
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="mb-2"><i class="fas fa-file-alt ml-2 text-muted"></i> متن پیام</label>
                                <textarea rows="6" name="content" class="form-control mb-2" placeholder="متن پیام خود را وارد نمایید" required></textarea>
                            </div>
                            <br>
                            <div class="text-left">
